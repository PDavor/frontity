...
const Izdvojeno = () => {
  return (
    ...
    <div className="container py-0 py-sm-4">
      <div className="row">
        <div className="col-sm-12 col-md-4 bg-plava text-light p-4">
          <h3>Izdvojeno</h3>
        ...
        <div className="col-sm-12 col-md-4 bg-plava bg-opacity-75 text-light p-4">
          <h3>Česta pitanja</h3>
          <p className="text-light">
